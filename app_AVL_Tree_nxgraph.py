...
# Draw AVL Tree using networkx (undirected graph)
def draw_tree(root):
...
# Streamlit UI
st.title("Simple AVL Tree Visualization (Undirected Graph)")
...
nx.draw(g, pos, with_labels=True, node_color="lightblue", node_size=1000, font_size=10, font_weight="bold", edge_color="gray")
st.pyplot(plt)
